...
class PalpationGrid(Node):
    ...
    def __init__(self):
        ...
        self.kin = VirtuosoKinematics(kappa_ik=23.9, kappa_fk=60.0, tool_len=0.015)
        ...
        raw_grid_points = [
            ...
            # [-0.010, -0.002, 0.033, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.033, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.033, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.033, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.033, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.033, 0, 0, 0, 1],
            # [0.002, -0.005, 0.033, 0, 0, 0, 1],
            # [0.004, -0.006, 0.033, 0, 0, 0, 1],
            # # [0.006, -0.007, 0.033, 0, 0, 0, 1],

            [-0.012, -0.002, 0.035, 0, 0, 0, 1],
            [-0.010, -0.002, 0.035, 0, 0, 0, 1],
            [-0.008, -0.003, 0.035, 0, 0, 0, 1],
            [-0.006, -0.003, 0.035, 0, 0, 0, 1],
            [-0.004, -0.004, 0.035, 0, 0, 0, 1],
            [-0.002, -0.004, 0.035, 0, 0, 0, 1],
            [-0.000, -0.005, 0.035, 0, 0, 0, 1],
            [0.002, -0.005, 0.035, 0, 0, 0, 1],
            [0.004, -0.006, 0.035, 0, 0, 0, 1],
            [0.006, -0.007, 0.035, 0, 0, 0, 1],


            [-0.012, -0.002, 0.037, 0, 0, 0, 1],
            [-0.010, -0.002, 0.037, 0, 0, 0, 1],
            [-0.008, -0.003, 0.037, 0, 0, 0, 1],
            [-0.006, -0.003, 0.037, 0, 0, 0, 1],
            [-0.004, -0.004, 0.037, 0, 0, 0, 1],
            [-0.002, -0.004, 0.037, 0, 0, 0, 1],
            [-0.000, -0.005, 0.037, 0, 0, 0, 1],
            [0.002, -0.005, 0.037, 0, 0, 0, 1],
            [0.004, -0.006, 0.037, 0, 0, 0, 1],
            [0.006, -0.007, 0.037, 0, 0, 0, 1],


            [-0.012, -0.002, 0.039, 0, 0, 0, 1],
            [-0.010, -0.002, 0.039, 0, 0, 0, 1],
            [-0.008, -0.003, 0.039, 0, 0, 0, 1],
            [-0.006, -0.003, 0.039, 0, 0, 0, 1],
            [-0.004, -0.004, 0.039, 0, 0, 0, 1],
            [-0.002, -0.004, 0.039, 0, 0, 0, 1],
            [-0.000, -0.005, 0.039, 0, 0, 0, 1],
            [0.002, -0.005, 0.039, 0, 0, 0, 1],
            [0.004, -0.006, 0.039, 0, 0, 0, 1],
            [0.006, -0.007, 0.039, 0, 0, 0, 1],

            # [-0.012, -0.002, 0.041, 0, 0, 0, 1],
            # [-0.010, -0.002, 0.041, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.041, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.041, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.041, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.041, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.041, 0, 0, 0, 1],
            # [0.002, -0.005, 0.041, 0, 0, 0, 1],
            # [0.004, -0.006, 0.041, 0, 0, 0, 1],
            # [0.006, -0.007, 0.041, 0, 0, 0, 1],

            # [-0.012, -0.002, 0.043, 0, 0, 0, 1],
            # [-0.010, -0.002, 0.043, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.043, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.043, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.043, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.043, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.043, 0, 0, 0, 1],
            # [0.002, -0.005, 0.043, 0, 0, 0, 1],
            # [0.004, -0.006, 0.043, 0, 0, 0, 1],
            # [0.006, -0.007, 0.043, 0, 0, 0, 1],


            # [-0.012, -0.002, 0.045, 0, 0, 0, 1],
            # [-0.010, -0.002, 0.045, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.045, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.045, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.045, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.045, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.045, 0, 0, 0, 1],
            # [0.002, -0.005, 0.045, 0, 0, 0, 1],
            # [0.004, -0.006, 0.045, 0, 0, 0, 1],
            # [0.006, -0.007, 0.045, 0, 0, 0, 1],


            # [-0.012, -0.002, 0.047, 0, 0, 0, 1],
            # [-0.010, -0.002, 0.047, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.047, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.047, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.047, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.047, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.047, 0, 0, 0, 1],
            # [0.002, -0.005, 0.047, 0, 0, 0, 1],
            # [0.004, -0.006, 0.047, 0, 0, 0, 1],
            # [0.006, -0.007, 0.047, 0, 0, 0, 1],

            # [-0.012, -0.002, 0.049, 0, 0, 0, 1],
            # [-0.010, -0.002, 0.049, 0, 0, 0, 1],
            # [-0.008, -0.003, 0.049, 0, 0, 0, 1],
            # [-0.006, -0.003, 0.049, 0, 0, 0, 1],
            # [-0.004, -0.004, 0.049, 0, 0, 0, 1],
            # [-0.002, -0.004, 0.049, 0, 0, 0, 1],
            # [-0.000, -0.005, 0.049, 0, 0, 0, 1],
            # [0.002, -0.005, 0.049, 0, 0, 0, 1],
            # [0.004, -0.006, 0.049, 0, 0, 0, 1],
            # [0.006, -0.007, 0.049, 0, 0, 0, 1],
        ...
        # CSV Logging Setup
        self.logfile = open('ik_small_grid_air.csv', 'w', newline='')
