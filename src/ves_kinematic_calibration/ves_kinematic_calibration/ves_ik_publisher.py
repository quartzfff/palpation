...
class PalpationGrid(Node):
    ...
    def __init__(self):
        ...
        raw_grid_points = [
            ...
            [-0.011, -0.002, 0.035, 0, 0, 0, 1],
            [-0.010, -0.002, 0.035, 0, 0, 0, 1],
            [-0.009, -0.002, 0.035, 0, 0, 0, 1],
            [-0.008, -0.002, 0.035, 0, 0, 0, 1],
            [-0.007, -0.002, 0.035, 0, 0, 0, 1],
            [-0.006, -0.002, 0.035, 0, 0, 0, 1],
        ]
        ...
        # CSV Logging Setup
        self.logfile = open('ik_test.csv', 'w', newline='')
