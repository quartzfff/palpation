...
class CalibrationCollector(Node):
    ...
    def __init__(self):
        ...
        self.grid_points = [
            [0.015, 0.0, 0.015, 0, 0, 0, 1],
            [0.015, 0.008, 0.02, 0, 0, 0, 1],



            [0.015, 0.0, 0.015, 0, 0, 0, 1],
            [0.015, -0.008, 0.015, 0, 0, 0, 1],


            [0.015, 0.0, 0.015, 0, 0, 0, 1],
            [0.006, 0.0, 0.017, 0, 0, 0, 1],

            [0.015, 0.0, 0.015, 0, 0, 0, 1],
            [0.023, 0.0, 0.015, 0, 0, 0, 1],
        ...
        # Logging
        # -----------------------
        self.logfile = open('hole_left_002.csv', 'w', newline='')
