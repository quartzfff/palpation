...
class CalibrationCollector(Node):
    ...
    def __init__(self):
        ...
        self.grid_points = [
            [0.012, -0.005, 0.025, 0, 0, 0, 1],
            [0.012, 0.003, 0.025, 0, 0, 0, 1],



            [0.012, -0.005, 0.025, 0, 0, 0, 1],
            [0.012, -0.013, 0.025, 0, 0, 0, 1],


            [0.012, -0.005, 0.025, 0, 0, 0, 1],
            [0.004, 0.0, 0.027, 0, 0, 0, 1],

            [0.012, -0.005, 0.025, 0, 0, 0, 1],
            [0.020, 0.0, 0.025, 0, 0, 0, 1],
        ...
        # Logging
        # -----------------------
        self.logfile = open('hole_left_new_001.csv', 'w', newline='')
