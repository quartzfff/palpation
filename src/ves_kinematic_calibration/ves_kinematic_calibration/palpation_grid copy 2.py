...
class PalpationGrid(Node):
    ...
    def __init__(self):
        ...
        self.grid_points = [
                ...
                [-0.012, -0.008, 0.030, 0, 0, 0, 1],
                [-0.011, -0.008, 0.030, 0, 0, 0, 1],
                [-0.010, -0.008, 0.030, 0, 0, 0, 1],
                [-0.009, -0.008, 0.030, 0, 0, 0, 1],
                [-0.008, -0.008, 0.030, 0, 0, 0, 1],
                [-0.007, -0.008, 0.030, 0, 0, 0, 1],
                [-0.006, -0.008, 0.030, 0, 0, 0, 1],
                [-0.005, -0.008, 0.030, 0, 0, 0, 1],
                [-0.004, -0.008, 0.030, 0, 0, 0, 1],
                [-0.003, -0.008, 0.030, 0, 0, 0, 1],
                [-0.002, -0.008, 0.030, 0, 0, 0, 1],
                [-0.001, -0.008, 0.030, 0, 0, 0, 1],
                [0.0000, -0.008, 0.030, 0, 0, 0, 1],
                [0.001, -0.008, 0.030, 0, 0, 0, 1],
                [0.002, -0.009, 0.030, 0, 0, 0, 1],
                [0.003, -0.009, 0.030, 0, 0, 0, 1],
                [0.004, -0.009, 0.030, 0, 0, 0, 1],
        ...
        # CSV
        self.logfile = open('15_deep_grid_air_001.csv', 'w', newline='')
