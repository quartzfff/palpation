...
class PalpationGrid(Node):
    ...
    def __init__(self):
        ...
        self.push_direction = normalize([0, -0.9, -0.1])
        ...
        self.grid_points = [
            ...
            [-0.012, -0.003, 0.015, 0, 0, 0, 1], #[-20,-7,25]
            [-0.011, -0.003, 0.015, 0, 0, 0, 1],
            [-0.010, -0.003, 0.015, 0, 0, 0, 1],
            [-0.009, -0.003, 0.015, 0, 0, 0, 1],
            [-0.008, -0.003, 0.015, 0, 0, 0, 1],

            [-0.007, -0.003, 0.015, 0, 0, 0, 1],
            [-0.006, -0.003, 0.015, 0, 0, 0, 1],
            [-0.005, -0.003, 0.015, 0, 0, 0, 1],
            [-0.004, -0.003, 0.015, 0, 0, 0, 1],
            [-0.003, -0.003, 0.015, 0, 0, 0, 1],

            [-0.002, -0.003, 0.015, 0, 0, 0, 1],
            [-0.001, -0.003, 0.015, 0, 0, 0, 1],
            [-0.000, -0.004, 0.015, 0, 0, 0, 1],
            [0.001, -0.005, 0.015, 0, 0, 0, 1],
            [0.002, -0.0055, 0.015, 0, 0, 0, 1],
            ...
            # [-0.009, -0.0033, 0.0145, 0, 0, 0, 1],
            # [-0.0084, -0.0033, 0.0141, 0, 0, 0, 1],
            # [-0.0078, -0.0032, 0.0138, 0, 0, 0, 1],
            # [-0.0072, -0.0032, 0.0134, 0, 0, 0, 1],


            # [-0.0067, -0.0031, 0.0131, 0, 0, 0, 1],
            # [-0.0062, -0.0031, 0.0128, 0, 0, 0, 1],
            # [-0.0057, -0.003, 0.0125, 0, 0, 0, 1],
            # [-0.0052, -0.003, 0.0122, 0, 0, 0, 1],
            # [-0.0047, -0.003, 0.012, 0, 0, 0, 1],

            # [-0.0043, -0.003, 0.0117, 0, 0, 0, 1],
            # [-0.0038, -0.003, 0.0115, 0, 0, 0, 1],
            # [-0.0033, -0.003, 0.0113, 0, 0, 0, 1],
            # [-0.0029, -0.0029, 0.0111, 0, 0, 0, 1],
            # [-0.0025, -0.0029, 0.011, 0, 0, 0, 1],
        ...
        # CSV
        self.logfile = open('flat_palpation_grid_003_center.csv', 'w', newline='')
